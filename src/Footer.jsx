...
const Footer = () => {
    return(
        <div className="w-full">
            <div className="footer w-full lg:flex bg-zinc-600  px-10 py-10 text-justify">
                <div className="1 pt-11">
                    <img src="https://static.tildacdn.com/tild6630-3465-4136-b830-656135383539/logo.svg" className="lg:pl-40 h-14" /><br />
                    <img src="https://cdn-icons-png.flaticon.com/512/3536/3536505.png" className= " lg:pl-40 h-10 px-9" /> <br /> <br />
                    <p className="lg:pl-40 font-thin text-xs">© 2022 Coders Valley. All rights reserved.</p> 
                </div>
                ...
                <div className="4 lg:pl-36 pt-11 text-zinc-400 space-y-3">
