...
const Footer = () => {
    return(
        <div className="w-full">
            <div className="footer w-full lg:flex bg-[#24305E]  px-10 py-10 text-justify">
                <div className="1 pt-11">
                    ...
                    <p className="lg:pl-40 font-thin text-gray-50 text-xs">© 2022 Company Name. All rights reserved.</p> 
                </div>
                <div className="2 lg:pl-36 pt-11 text-gray-50 text-base space-y-3 text-align-center" >
                ...
                <div className="3 lg:pl-36 pt-11 text-gray-50 space-y-3">
                    <p className="font-bold text-xl">Policy</p>
                    <p>Privacy Policy </p>
                    <p>Cookie Policy</p>
                </div>
                <div className="4 lg:pl-36 pt-11 text-gray-50 space-y-3">
