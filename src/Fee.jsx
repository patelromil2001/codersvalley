        ...
        <div className="w-full bg-slate-100">
            ...
            <div class=" mx-auto  rounded overflow-hidden shadow-xl w-[80%] md:w-1/2 lg:w-1/3 bg-white">
                <div class="px-6 py-4 text-center">
                    <div class="text-3xl font-[400] tracking-wide mb-2">Success Fee</div>
                    ...
                    <div className="my-10"><span className="text-5xl font-[600]">12-19%</span></div>
                    <div className="space-y-5 ">
                        <div><span className=" font-bold">of the placed employee's first year's base salary</span></div>
